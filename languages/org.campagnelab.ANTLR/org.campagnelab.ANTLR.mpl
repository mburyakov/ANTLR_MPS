...
<language namespace="org.campagnelab.ANTLR" uuid="d6782141-eafa-4cf7-a85d-1229abdb1152" languageVersion="3" moduleVersion="0">
  <models>
    <modelRoot contentPath="${module}" type="default">
      <sourceRoot location="languageModels" />
    </modelRoot>
    <modelRoot contentPath="${module}" type="java_classes">
      <sourceRoot location="grammarsv4.jar" />
    </modelRoot>
  </models>
  <accessoryModels />
  <stubModelEntries>
    <stubModelEntry path="${module}/grammarsv4.jar" />
  </stubModelEntries>
  <sourcePath />
  <languageVersions>
